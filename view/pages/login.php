...
<body class="bg-black text-white">
    ...
    <div class="h-[80vh] center max-w-screen-xl mx-auto">
        <form class="w-1/3" action="/login" method="POST">
            ...
            <button type="submit" class="text-white bg-indigo-400 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">Log In</button>
        </form>
