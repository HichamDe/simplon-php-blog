<div class="bg-black text-white">
    ...
    <article class="max-w-2xl px-6 py-24 mx-auto space-y-12 ">
        <div class="w-full mx-auto space-y-4 text-center">
            ...
            <p class="text-sm dark:text-gray-200">by
        ...
        <div class="pt-12 border-t dark:border-gray-200">
            ...
            <div class="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                <div class="flex flex-col">
                    ...
                    <p class="dark:text-gray-200">Sed non nibh iaculis, posuere diam vitae, consectetur neque. Integer velit ligula, semper sed nisl in, cursus commodo elit. Pellentesque sit amet mi luctus ligula euismod lobortis ultricies et nibh.</p>
                </div>
            </div>
            <div class="flex justify-center pt-4 space-x-4 align-center">
                <a rel="noopener noreferrer" href="#" aria-label="GitHub" class="p-2 rounded-md dark:text-gray-300 hover:dark:text-violet-600">
                ...
                <a rel="noopener noreferrer" href="#" aria-label="Dribble" class="p-2 rounded-md dark:text-gray-300 hover:dark:text-violet-600">
                ...
                <a rel="noopener noreferrer" href="#" aria-label="Twitter" class="p-2 rounded-md dark:text-gray-300 hover:dark:text-violet-600">
                    <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current">
                ...
                <a rel="noopener noreferrer" href="#" aria-label="Email" class="p-2 rounded-md dark:text-gray-300 hover:dark:text-violet-600">
                    <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current">
    ...
    <section class=" py-8 lg:py-16 antialiased">
        <div class="max-w-2xl mx-auto px-4">
            ...
            <form class="mb-6">
                <div class="py-2 px-4 mb-4  rounded-lg rounded-t-lg">
                    <label for="comment" class="sr-only">Your comment</label>
                    <textarea id="comment" rows="6" class="p-3 w-full text-sm text-gray-900 border-0 focus:ring-0 focus:outline-none dark:text-white dark:placeholder-gray-400 dark:bg-white/10" placeholder="Write a comment..." required></textarea>
                </div>
            ...
            <article class="p-6 text-base bg-white rounded-lg dark:bg-white/10">
